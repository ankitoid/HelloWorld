...
const CaseStudies = () => {
  return (
    <div className="bg-white">
      ...
      <div className="max-w-7xl mx-auto py-0 px-4 sm:px-6 lg:px-0">
        ...
        <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg w-full md:w-96 flex flex-col">
            <h2 className="text-lg font-semibold mb-2">
                Design and Installation - Cisco Webex Meetings Server
              (CWMS)
            </h2>
            <p className="text-sm text-gray-700 mb-4">
      ...
      <div className="mt-10 max-w-7xl mx-auto items-center justify-center">
