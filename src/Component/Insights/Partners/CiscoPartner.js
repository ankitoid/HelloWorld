...
import Certification4 from "../../../Assets/enterprise.png";
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            Earners of this track can architect, implement, support and troubleshoot CISCO security technologies using current best practices of cybersecurity.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            />
            <p className="text-gray-600">
              CCIE Data Center Earners of this track of the CCIE can design,
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            />
            <p className="text-gray-600">
              Earners of the Emeritus status have possessed the CCIE
              certification for 10 years. Earners of the Lifetime Emeritus
              status have held this certification for 20.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            />
            <p className="text-gray-600">
              Holders of this certification can build and maintain enterprise
              networks and possess knowledge of network infrastructure,
              virtualization, automation, assurance, and security.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center px-4 space-y-12 py-16">
        ...
        <p className="max-w-3xl mx-auto text-gray-700 text-center">
          As a Cisco partner, GlobalXperts offers comprehensive services,
          including configuration, maintenance, support, and troubleshooting of
          Cisco devices. We also provide network patching and network security
          services.
        </p>
        <p className="max-w-3xl mx-auto text-gray-700 text-center">
