        ...
        <div className="max-w-6xl mx-auto bg-white p-6 sm:p-8 rounded-lg shadow-md">
          ...
          <div className="bg-white p-6 sm:p-8 mt-8 text-gray-800">
            ...
            <p className="text-gray-700 text-sm sm:text-lg mb-6">
              <strong>Contact:</strong> Jake Heins – Director of Business
              Development –{" "}
              <span className="hidden">Jake.Heins@globalxperts.net</span> (email
              provided for context, consider using a contact form or link
              instead)
            </p>
          </div>
