...
import storageImg from '../../../Assets/blogpost2.webp'; 
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8">
            ...
            <div className="lg:w-3/5">
              ...
              <p className="text-gray-700 text-sm sm:text-lg">
                ...
                shifted gear and roared past a major milestone! We’re thrilled
                to announce that we’ve successfully navigated the rigorous
                gauntlet of the Amazon Storage Field Technical Review (FTR),
                emerging as certified masters of the AWS storage domain.
              </p>
            </div>
