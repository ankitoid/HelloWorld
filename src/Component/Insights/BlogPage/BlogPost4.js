...
const BlogPost4 = () => {
  return (
    <>
      <Navbar />
      <div className="flex justify-center items-center bg-gray-100 py-8 sm:py-12">
        <div className="bg-white max-w-6xl w-full p-6 sm:p-8 rounded-lg shadow-md text-gray-800">
          ...
          <p className="text-gray-700 text-sm sm:text-lg mb-6 text-justify">
            ...
            <a href="https://www.linkedin.com/company/globalxperts-inc" className="text-blue-500 hover:underline">
              LinkedIn Overview
            </a>.
          </p>
