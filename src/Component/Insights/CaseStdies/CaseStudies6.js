...
import CS6 from "../../../Assets/CaseStudiesImage/CS6.png";
      ...
      <div className=" bg-blueCustomColor  w-full">
        <div className="max-w-7xl mx-auto py-20 lg:h-[70vh] 2xl:h-[50vh]">
          <div className="h-auto  flex flex-col items-center lg:flex-row justify-betweenpx-6 lg:px-16">
            <div className="w-full  text-center lg:text-left order-2 lg:order-1">
              <h2 className="text-3xl sm:mt-40 lg:text-5xl font-bold text-white mt-10 lg:mt-20 2xl:mt-20">
                Global WAN Optimization Project
              </h2>
          ...
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:justify-between text-md text-white mb-8 space-y-2 md:space-y-0 px-4 mt-8">
            <div>
              <span className="font-bold">SOLUTION:</span> Professional
              Services/Field Engineering Services
            </div>
            <div>
