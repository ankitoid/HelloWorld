  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between">
        ...
        <div>
          <p className="text-md max-w-6xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto text-left grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-md">
              We provided detailed reports and analytics, empowering the team to
              understand audience behavior and optimize their content strategy.
            </p>
          </div>

          {/* Solution Column 2 */}
          <div className="space-y-6">
            <h3 className="font-bold">• AWS Media Link for Direct Delivery:</h3>
            <p className="text-md">
            ...
            <p className="text-md">
              ...
              for video files. Files are accessed via HTTP, which is perfect for
              serving HLS videos.
            </p>

            <h3 className="font-bold">• Proactive Maintenance:</h3>
            <p className="text-md">
              Our team proactively adjusted bitrates during peak viewership and
              optimized server configurations, resolving video/audio issues
        ...
        <div>
          <div className="max-w-6xl mx-auto text-left grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <h3 className="font-bold">• Reduction in Infrastructure Cost:</h3>
              <p className="text-md">
                By deploying AWS services, cost has been reduced by 70 to 80% in
                comparison to conventional streaming solutions which use costly
                hardware-based encoders and decoders for video processing and
                video compression and has extra licensing cost to enhance
                features. AWS services follow Pay As you Go pricing model to
                make it less expensive.
              </p>

              <h3 className="font-bold">• Reduced Staff Workload:</h3>
              <p className="text-md">
                Leveraging AWS freed up staff by 40%, enabling them to focus on
                new initiatives.
              </p>
            </div>
