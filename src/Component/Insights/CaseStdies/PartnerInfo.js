  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto p-6 md:p-8 mt-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="font-bold text-lg md:text-xl mb-2">
              <span className="text-xl md:text-2xl">Field Services</span> –
            ...
            <p className="font-bold text-lg md:text-xl mb-2">
              <span className="text-xl md:text-2xl">Consulting Services</span> –
            ...
            <p className="font-bold text-lg md:text-xl mb-4">
              <span className="text-xl md:text-2xl">Delivering Success</span> –
              Through our partnership, we enable support teams and design build
              teams to deliver some of the most "state of the art" data centers
              on the planet.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-center mb-10">Arista Products</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {products.map((product, index) => (
            <div key={index} className="bg-gray-100 rounded-lg shadow-lg p-6">
              ...
              <a href={product.link} className="text-green-600 hover:underline">
                READ MORE »
              </a>
