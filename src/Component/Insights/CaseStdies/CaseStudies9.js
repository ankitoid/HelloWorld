...
import cs9 from "../../../Assets/CaseStudiesImage/cs9.png";
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 text-base leading-relaxed">
          Founded in 1971, Close Up Foundation is a nonprofit, nonpartisan,
          civic education organization that believes a strong democracy
          requires active, informed participation by all citizens. Therefore,
          they seek to serve young people from all communities and all
          backgrounds, regardless of race, religion, gender, socioeconomic
          level, or academic standing.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 text-base leading-relaxed">
          GlobalXperts, acting as a subcontractor for Red River, was engaged
          to diagnose a web server issue involving an Amazon AWS server
          Instance (EC2) and produce a functional AWS server.
        </p>
        <p className="text-gray-700 text-base leading-relaxed mt-4">
          <strong>Data-driven insights:</strong> We provided detailed reports
          and analytics, empowering the team to understand server performance
          and behavior and optimize compute power needed and storage needs.
        </p>
      </section>
