  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Navigation Links */}
        <ul className="hidden  md:flex lg:flex space-x-4 md:space-x-0 items-center ml-8  ">
          {/* Home link */}
                ...
                <ul>
                  ...
                  >
                    ...
                    >
                      ...
                      <Link
                        to="/solutions/cloud/Blockchain-Technology"
                        onClick={() => setShowSubmenu2(false)}
                      >
                        <li className="hover:bg-greenCustomColor2 hover:font-bold hover:text-white p-2 rounded text-center">
                    ...
                    <li>
                      ...
                      {showSubmenu2 && (
                        <ul className="pl-4 space-y-2 transition-all duration-700 ease-in-out overflow-hidden ">
                          ...
                          <li>
                            <Link to="/solutions/cloud/TitanX">
                            Titan X
                            </Link>
                          </li>
                          <li>
                          ...
                          <li>
                            <Link to="/solutions/cloud/Blockchain-Technology">
                            Blockchain Technology
                            </Link>
                          </li>
                          <li>
