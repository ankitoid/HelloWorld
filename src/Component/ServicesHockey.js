...
function ThoughtCard({
  ...
  return (
    ...
    >
      {/* Overlay for better text readability (initial opacity is very low) */}
      <div
      ...
      <div className="relative z-10 flex flex-col justify-between h-full p-4">
        ...
        {buttonText && (
          <button className="bg-greenCustomColor hover:bg-greenCustomColor2 text-white font-bold py-2 px-4 rounded-full self-center mb-16">
            {buttonText}
          </button>
        )}
