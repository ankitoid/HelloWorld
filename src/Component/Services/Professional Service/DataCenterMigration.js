...
const DataCenterMigration = () => {
  return (
    ...
    <Helmet>
        ...
        <meta name="description" content="Data Center Migration" />
      </Helmet>
      <Navbar/>
          ...
          <div className="h-auto  flex flex-col items-center lg:flex-row justify-betweenpx-6 lg:px-16">
            ...
            <div className="w-full text-center lg:text-left mt-10 lg:mt-20 order-3 lg:order-2">
              <p className="text-base lg:text-lg text-white max-w-xl mx-auto lg:mx-0 lg:mb-0 leading-relaxed">
                ...
                specific needs and requirements. Contact us today to learn
                more!”
              </p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <h1 className="text-3xl lg:text-5xl text-center font-bold text-gray-700 mt-20">
          Value Proposition
        </h1>
