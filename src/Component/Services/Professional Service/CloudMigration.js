...
const CloudMigration = () => {
  return (
    <>
      ...
      <Helmet>
        <title>
          Cloud Migration Services | IT Services Company in Ahmedabad
        </title>
        <meta
          name="description"
          content="We provide cloud migration services in Ahmedabad. Our team of experts can help you migrate your data to the cloud with ease and efficiency."
        />
      ...
      <div className="bg-gray-50 py-16 px-6 md:px-16 max-w-6xl mx-auto">
        ...
        <div className="mt-12 text-center">
          ...
          <div className="text-left space-y-4 max-w-3xl mx-auto">
            <p className="text-gray-600">
              <strong>Proven Expertise:</strong> Our team of skilled professionals specializes in cloud migrations and data center transitions. Leveraging the latest tools and best practices, we ensure smooth, efficient migrations tailored to your needs.
            </p>
            <p className="text-gray-600">
              <strong>Customized Solutions:</strong>We collaborate closely with you to design migration strategies that align with your business goals.
            </p>
            <p className="text-gray-600">
              <strong>Minimized Downtime and Risk:</strong> Using advanced tools and methodologies, we mitigate security risks and minimize disruption to your operations during the migration process.
            </p>
            <p className="text-gray-600">
              <strong>Accelerated Value:</strong>  With faster deployment times, GlobalXperts enables you to start benefiting from your new cloud infrastructure sooner than traditional approaches.
            </p>
            <p className="text-gray-600">
              <strong>Cost-Effective Outcomes:</strong> Our optimized solutions reduce IT costs while increasing efficiency, helping you achieve more for less.
            </p>
            <p className="text-gray-600">
              <strong>Ongoing Support:</strong>  We don’t just migrate and leave. GlobalXperts provides continuous support to ensure your cloud infrastructure remains secure, up-to-date, and primed for future growth.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 text-center">
          ...
          Ready to transform your business with a cloud solution designed to meet your unique needs? Contact GlobalXperts today and discover how we can make your cloud migration seamless and successful.
          </p>
