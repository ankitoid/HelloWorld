  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="description" content=" Technical Staff Augmentation" />
      </Helmet>
      ...
      <div className=" bg-blueCustomColor  w-full">
        <div className="max-w-7xl mx-auto py-20 lg:h-[70vh] 2xl:h-[50vh]">
          <div className="h-auto  flex flex-col items-center lg:flex-row justify-betweenpx-6 lg:px-16">
            ...
            <div className="w-full text-center lg:text-left mt-10 lg:mt-20 order-3 lg:order-2 md:p-0 p-2">
      ...
      <div className="text-center mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-gray-600">
            <div className="w-16 h-16 bg-red-600 text-white rounded-full flex items-center justify-center text-2xl mb-4">
            ...
            <p>Access technical resources in over one hundred countries to support technology upgrades and installations worldwide.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex items-center text-gray-600">
            ...
            <div>
              ...
              <p>With a presence in over one hundred countries, we offer unparalleled support and resources for your IT initiatives.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="text-center">
        ...
        <button className="bg-blue-600 text-white text-lg font-semibold py-3 px-6 rounded-md hover:bg-blue-700">
          Get Started Today
        </button>
      </div>
    </div>
