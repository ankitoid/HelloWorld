...
import { 
  Server, Shield, MonitorSmartphone, Building, Cloud, 
  CloudCog, Activity, Ticket, Settings 
} from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 max-w-7xl mx-auto p-4">
        ...
        <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-6 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[300px] md:max-w-xl max-w-xs sm:max-w-[200px] mx-auto rounded-xl">
          <div className="flex flex-col items-center flex-grow">
            ...
            <ul className="text-md text-gray-600 mb-0 text-left list-disc ml-4">
              <li>
                <strong className="font-bold">24/7 System Monitoring:</strong> Continuous monitoring of critical
                systems to ensure uptime.{" "}
              </li>
              <li>
                <strong>Help Desk Support:</strong> Basic troubleshooting and remote assistance
                for end users.{" "}
              </li>
              <li>
                <strong>Patch Management: </strong> Regular updates and patch installations for
                software and systems.
              </li>
              <li>
                <strong>Antivirus and Malware Protection:</strong> Protection against viruses,
                malware, and other threats.
              </li>
              <li>
                <strong>Backup & Disaster Recovery:</strong> Automated daily backups with
                recovery options.
              </li>
            </ul>
          </div>
        ...
        <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-6 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[300px] md:max-w-xl max-w-xs sm:max-w-[200px] mx-auto rounded-xl">
          <div className="flex flex-col items-center flex-grow">
            ...
            <ul className="text-md text-gray-600 mb-0 text-left list-disc ml-4">
              <li>
                <strong>Advanced Network Management:</strong> Proactive monitoring and
                optimization of network performance.
              </li>
              <li>
                <strong>Cloud Optimization and Management:</strong> Cloud resource usage
                management for cost savings and efficiency.
              </li>
              <li>
                <strong>Device Management (Mobile & Desktop):</strong> Centralized management of
                desktops, laptops, and mobile devices.
              </li>
              <li>
                <strong>Vendor Management:</strong> Coordination with third-party vendors for
                software and hardware support.
              </li>
              <li>
                <strong>User Training & Security Awareness:</strong> Regular sessions on best IT
        ...
        <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-6 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[300px] md:max-w-xl max-w-xs sm:max-w-[200px] mx-auto rounded-xl">
          <div className="flex flex-col items-center flex-grow">
            ...
            <ul className="text-md text-gray-600 mb-0 text-left list-disc ml-4">
              <li>
               <strong> Cybersecurity Incident Response:</strong> Full incident response in case
                of a breach or cyberattack.
              </li>
              <li>
                <strong>Custom IT Strategy & Roadmap:</strong> Development of a strategic IT plan
                mapped to business goals.
              </li>
              <li>
                <strong>Compliance Management:</strong> Ensuring systems meet industry
                regulations like HIPAA, GDPR, etc.
              </li>
              <li>
                <strong>Data Analytics and Reporting:</strong> Advanced analytics tools to
                provide insights into performance and productivity.
              </li>
              <li>
                <strong>AI/ML and IoT Support:</strong> Managing and supporting advanced
      ...
      <div className="bg-gray-50 py-4 px-6 max-w-7xl mx-auto">
        ...
        <p className="text-lg text-center text-gray-600 mb-10">
          GlobalXperts’ cloud operations managed services can become an extension of your daily operations, supporting your business goals and objectives. Our team can deliver cloud capabilities to expertly support and simplify your operations through AI/ML tools, automation, and continuous innovation. We also concentrate on improving consistency, lowering costs and promoting compliance.
        </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-center">
        ...
        <div className="flex flex-col items-center space-y-2">
          ...
          <span className="text-lg font-semibold">Applications & Endpoints</span>
        </div>
        ...
        <div className="flex flex-col items-center space-y-2">
          ...
          <span className="text-lg font-semibold">Public, Hybrid, Multi-Cloud</span>
        </div>

        {/* Monitoring & Response */}
        <div className="flex flex-col items-center space-y-2">
          <Activity size={64} className="text-pink-500" />
          <span className="text-lg font-semibold">Monitoring & Response</span>
        </div>

        {/* Ticket Escalation */}
        <div className="flex flex-col items-center space-y-2">
          <Ticket size={64} className="text-teal-500" />
          <span className="text-lg font-semibold">Ticket Escalation (L1 - L3)</span>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 text-center">
            <div className="mb-4">
              <img src="https://main-website-images1.s3.ap-south-1.amazonaws.com/Services/Managed-Services/AWservice.jfif" alt="AWS" className="mx-auto h-20" />
            </div>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 text-center">
            <div className="mb-4">
              <img src="https://main-website-images1.s3.ap-south-1.amazonaws.com/Services/Managed-Services/MicrosoftAzure.png" alt="Microsoft Azure" className="mx-auto h-20" />
            </div>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 text-center">
            <div className="mb-4">
              <img src="https://main-website-images1.s3.ap-south-1.amazonaws.com/Services/Managed-Services/google2.jpg" alt="Google Cloud" className="mx-auto h-20" />
            </div>
            {/* <h3 className="text-2xl font-semibold text-gray-800 mb-4">
              Google Cloud
            </h3> */}
      ...
      <div className="bg-gray-50 py-10 px-5 sm:px-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            {
              icon: <amazonwebservices size={30} className="text-blue-800" />,
        ...
        <div className="relative mt-12 lg:mt-0 lg:w-1/2 px-5  ">
          ...
          <div className="relative">
            <img
              ...
              src="https://main-website-images1.s3.ap-south-1.amazonaws.com/Services/Managed-Services/managedServiceB.png"
            />
          </div>
        </div>
      </div>
