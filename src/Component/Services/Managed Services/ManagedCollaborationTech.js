  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="description" content="Managed Collaboration Technologies" />
      </Helmet>
      ...
      <p className="text-lg leading-relaxed text-center text-gray-600 max-w-6xl mx-auto">
        ...
        comprehensive solution to optimize your communication infrastructure and
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 max-w-6xl mb-8">
          ...
          <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-8 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px]">
            <div className="flex flex-col items-center flex-grow ">
              ...
              <p className="text-sm text-gray-600 mb-0 text-center">
                Secondly, we provide a reliable solution that minimizes downtime
                and maximizes productivity. Our proactive monitoring and support
                ensure that any issues are resolved quickly, allowing your team
          ...
          <div className="bg-white  2xl:bg-gray-100 shadow-2xl p-8 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px]">
            <div className="flex flex-col items-center flex-grow">
              ...
              <p className="text-sm text-gray-600 mb-0 text-center">
                ...
                tailor our solution to meet your unique needs. Whether you need
                a complete overhaul of your communication infrastructure or
                simply want to optimize your current setup, we have the
