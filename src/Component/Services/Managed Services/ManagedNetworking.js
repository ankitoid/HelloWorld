  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="description" content="Managed Cloud Application" />
      </Helmet>
      ...
      <div className="max-w-7xl mx-auto  mt-10 px-4 bg-gray-100 2xl:bg-white ">
        ...
        <div className="mt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
          <p className="text-gray-700 leading-relaxed font-semibold text-lg text-center">
            Overall, the NOC plays a critical role in maintaining the health and
      ...
      <div className="max-w-7xl mx-auto   py-4  bg-gray-100 2xl:bg-white">
        ...
        <p className="text-lg text-gray-700 mb-8 text-center">
          ...
          Enterprise Networking Services is the ability to provide reliable and
          secure network infrastructure that supports business operations. By
          utilizing a NOC, enterprises can benefit from the following:
        </p>
