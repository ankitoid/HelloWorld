...
const ManagedOpsis = () => {
  return (
    <>
      ...
      <Helmet>
        <title>Opsis Streaming</title>
        <meta name="description" content="Opsis Streaming" />
      </Helmet>
      ...
      <div className="bg-gray-100  2xl:bg-white p-4">
        ...
        <div className=" max-w-7xl mx-auto p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 px-4">
            {[
              {
                image: "https://main-website-images1.s3.ap-south-1.amazonaws.com/solutions/Cloud-Solutions/Aws-Tech-Img/AWSElementalMediaLive.jpg",
                title: "AWS Elemental MediaLive",
                description:
                  " Cloud-based, broadcast-grade live video processing service.",
              },
              {
                image: "https://main-website-images1.s3.ap-south-1.amazonaws.com/solutions/Cloud-Solutions/Aws-Tech-Img/AWSElementalLive2.webp",
              ...
              {
                image: "https://main-website-images1.s3.ap-south-1.amazonaws.com/solutions/Cloud-Solutions/Aws-Tech-Img/AWSElementalMediaPackage.png",
              ...
              {
                image: "https://main-website-images1.s3.ap-south-1.amazonaws.com/solutions/Cloud-Solutions/Aws-Tech-Img/elemental-mediaTaylor.svg",
              ...
              {
                image: "https://main-website-images1.s3.ap-south-1.amazonaws.com/solutions/Cloud-Solutions/Aws-Tech-Img/elastic-transcoder.svg",
              ...
              {
                image: "https://main-website-images1.s3.ap-south-1.amazonaws.com/solutions/Cloud-Solutions/Aws-Tech-Img/AWSCloudfront.png",
