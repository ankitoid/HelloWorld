...
import ElasticTranscoder from "../../../Assets/SMBsLogo/elastic-transcoder.svg";
import ElementalMedia from "../../../Assets/SMBsLogo/elemental-mediaTaylor.svg";
import { MdOutlineLibraryBooks, MdSecurity } from "react-icons/md";
import {  AiFillSignal } from "react-icons/ai";
import { BiLineChart } from "react-icons/bi";
import { FiDatabase } from "react-icons/fi";
import opsisStream from '../../../Assets/SMBsLogo/opsisworkflow.png'
    ...
    <>
      ...
      <div className="bg-gray-100  2xl:bg-white p-4">
        ...
        <div className="bg-gray-100 2xl:bg-white flex flex-col items-center justify-center 2xl:mt-8 mb-12 md:p-8 lg:p-0">
          ...
          {/* Paragraph */}
          <p className="text-md text-gray-600 mb-4 px-4 text-center max-w-4xl">
      ...
      <h1 className="text-3xl font-bold text-blue-700 text-center mt-6 mb-4  ">Typical workflow</h1>
      <p className="border-t-2 border-gray-200 mt-8"> </p>
