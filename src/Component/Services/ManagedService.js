...
import AWS from "../../Assets/AWservice.jfif";
import GCP from "../../Assets/google2.jpg";
...
const ManagedServices = () => {
  ...
  const faqs = [
    {
      question:
        "How does a Managed Cloud Application service benefit my business?",
      answer:
        "Managed Cloud Application services handle the hosting, maintenance, and updates of your cloud applications, ensuring high availability, security, and scalability. This allows your business to focus on core operations while reducing IT overhead and infrastructure costs.",
    },
  ...
  return (
    <>
      <Navbar />
      <Helmet>
        <title>GlobalXperts Managed IT Services</title>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 max-w-7xl mx-auto p-4">
        ...
        <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-6 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[300px] md:max-w-xl max-w-xs sm:max-w-[200px] mx-auto rounded-xl">
          <div className="flex flex-col items-center flex-grow">
            ...
            <ul className="text-md text-gray-600 mb-0 text-left list-disc ml-4">
              <li>
                24/7 System Monitoring: Continuous monitoring of critical
                systems to ensure uptime.{" "}
              </li>
              <li>
                Help Desk Support: Basic troubleshooting and remote assistance
                for end users.{" "}
              </li>
              <li>
                Patch Management: Regular updates and patch installations for
                software and systems.
              </li>
              <li>
                Antivirus and Malware Protection: Protection against viruses,
                malware, and other threats.
              </li>
              <li>
                Backup & Disaster Recovery: Automated daily backups with
                recovery options.
              </li>
            </ul>
          </div>
        ...
        <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-6 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[300px] md:max-w-xl max-w-xs sm:max-w-[200px] mx-auto rounded-xl">
          <div className="flex flex-col items-center flex-grow">
            ...
            <ul className="text-md text-gray-600 mb-0 text-left list-disc ml-4">
              <li>
                Advanced Network Management: Proactive monitoring and
                optimization of network performance.
              </li>
              <li>
                Cloud Optimization and Management: Cloud resource usage
                management for cost savings and efficiency.
              </li>
              <li>
                Device Management (Mobile & Desktop): Centralized management of
                desktops, laptops, and mobile devices.
              </li>
              <li>
                Vendor Management: Coordination with third-party vendors for
                software and hardware support.
              </li>
              <li>
                User Training & Security Awareness: Regular sessions on best IT
                practices and cybersecurity. Chalk talk sessions on difficult
                tickets among NOC staff.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-6 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[300px] md:max-w-xl max-w-xs sm:max-w-[200px] mx-auto rounded-xl">
          <div className="flex flex-col items-center flex-grow">
            ...
            <ul className="text-md text-gray-600 mb-0 text-left list-disc ml-4">
              <li>
                Cybersecurity Incident Response: Full incident response in case
                of a breach or cyberattack.
              </li>
              <li>
                Custom IT Strategy & Roadmap: Development of a strategic IT plan
                mapped to business goals.
              </li>
              <li>
                Compliance Management: Ensuring systems meet industry
                regulations like HIPAA, GDPR, etc.
              </li>
              <li>
                Data Analytics and Reporting: Advanced analytics tools to
                provide insights into performance and productivity.
              </li>
              <li>
                AI/ML and IoT Support: Managing and supporting advanced
                technologies like AI, machine learning, and IoT with automation
                and optimized solutions to align with customer’s objectives.
              </li>
            </ul>
          </div>
        </div>
      ...
      <h1 className="text-4xl font-bold text-center mt-12">
        {" "}
        <h1>Explore our managed services</h1>
      </h1>
      <div className="bg-white max-w-7xl mx-auto flex items-center justify-center p-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 max-w-6xl">
          ...
          <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-8 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px]">
            ...
            <Link
              to="/service/Managed-Collaboration-Technologies"
      ...
      <div className="md:max-w-4xl md:mx-auto flex items-center justify-center  p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 ">
          ...
          <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-8 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px] md:min-w-[350px]">
            ...
            <Link
              to="/service/Managed-Cyber-Security"
              className="text-blue-700 text-sm font-medium hover:underline flex items-center justify-center mt-auto"
            >
              Read More <span className="ml-2">&rarr;</span>
            </Link>
      ...
      <div className=" bg-gray-50 max-w-7xl mx-auto flex items-center justify-center rounded-lg shadow-md">
        <div className="mt-8 bg-white p-8 w-full rounded-lg shadow-md">
          <h4 className="text-lg font-bold text-gray-800 mb-4">
            Optional Service for All Tiers:
          </h4>
          ...
          <p className="text-gray-700">
            ...
            hundreds of cities throughout the United States and 100 other
            countries.
          </p>
      ...
      <div className="bg-gray-100 py-10 px-6 max-w-7xl mx-auto">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 mb-4">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <li>
              <strong>Mobile Device Management:</strong> Secure management of
              mobile devices with encryption, app control, and remote wiping
              capabilities.
            </li>
            <li>
            ...
            <li>
              <strong>IoT Device Management:</strong> Overseeing the lifecycle,
              security, and performance of your Internet of Things devices.
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <li>Smartphones and Tablets (iOS, Android)</li>
            <li>Smart appliances</li>
            <li>Thin clients and Virtual Desktop Infrastructure (VDI)</li>
            <li>IoT devices (smart appliances, sensors, industrial IoT)</li>
          </ul>
        </div>

        <p className="text-center text-gray-600 mt-8">
          We manage the full spectrum of endpoints, including traditional
          workstations, mobile devices, and the rapidly expanding world of IoT.
        </p>
      </div>

      <div className="bg-gray-50 py-10 px-6 max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-8">
          Cloud Management
        </h2>
        <p className="text-lg text-center text-gray-600 mb-10">
          With ever-evolving technological change and advancements, many
          companies struggle to streamline their operations and manage their
          risks; this can drive up costs and give competitors a greater
          advantage.
        </p>
        ...
        <p className="text-lg text-gray-600 mb-10">
          We have extensive experience in IT operations and transformation
          services that we offer as integral capabilities of our managed
          services offering. We can deliver support for infrastructure,
          security, applications and endpoints that leverage our advanced
          network operations centers. On-premises, private and public cloud,
          multi-cloud and hybrid cloud services support include monitoring and
          response with ticket escalation from L1 through L3 support across
          infrastructure, cloud, enterprise, network, security, and
          applications​.
        </p>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 text-center">
            <div className="mb-4">
              <img src={AWS} alt="AWS" className="mx-auto h-20" />
            </div>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 text-center">
            <div className="mb-4">
              <img src={Azure} alt="Microsoft Azure" className="mx-auto h-20" />
            </div>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 text-center">
            <div className="mb-4">
              <img src={GCP} alt="Google Cloud" className="mx-auto h-20" />
            </div>
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">
              Google Cloud
            </h3>
      ...
      <div className="bg-gray-50 py-10 px-5 sm:px-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            {
              icon: <SiMicrosoft size={30} className="text-blue-800" />,
