...
const FieldServiceOnsite = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title> Managed Onsite Services </title>
        <meta name="description" content="   Managed Onsite Services " />
      </Helmet>
      ...
      <div className="flex flex-col md:flex-row items-center bg-white 2xl:bg-white   rounded-lg shadow-md p-6 py-4 max-w-7xl mx-auto mt-12">
        ...
        <div className="w-full md:w-1/2">
            <img
              className="w-full rounded-lg" // this image need to change
        ...
        <div className=" max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between">
          <div className="text-center lg:text-left lg:w-1/2 lg:pr-8">
            <h2 className="text-3xl font-bold text-white sm:text-4xl">
              Benefits of On-Site Repair Service
            </h2>
