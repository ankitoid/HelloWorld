...
import FieldEngineering from "../../../Assets/image (9).png";
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="description" content="Field Services Engineering" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto py-20 lg:h-[70vh] 2xl:h-[50vh]">
          <div className="h-auto  flex flex-col items-center lg:flex-row justify-betweenpx-6 lg:px-16">
            ...
            <div className="w-full text-center lg:text-right mt-10 lg:mt-0 order-3 lg:order-2">
              <p className="text-base lg:text-lg text-white max-w-xl mx-auto lg:mx-0 lg:mb-0 leading-relaxed mt-8">
      ...
      <div className="flex flex-col md:flex-row items-center bg-white 2xl:bg-white   rounded-lg shadow-md p-6 py-4 max-w-7xl mx-auto mt-12">
        ...
        <div className="w-full md:w-1/2">
          <img
            src={FieldEngineering} // Replace with the actual image path
            alt="Boost outcomes"
        ...
        <div className="w-full md:w-1/2 mt-6 md:mt-0 md:pl-6">
          ...
          <p className="mt-4 text-gray-600">
            Managing today’s complex IT environments demands agility, expertise,
            and a commitment to minimizing downtime. At GlobalXperts, we provide
            unparalleled Field Engineering Services designed to seamlessly
            integrate with your business operations. Whether you need to deploy
            modern technology, upgrade infrastructure, resolve outages, or scale
            operations following a cloud migration, our global network of
            engineers and Smart Hands technicians ensure your IT challenges are
            met with efficiency and expertise.
          </p>
      ...
      <div className="bg-gray-100  2xl:bg-white py-2 max-w-6xl mx-auto md:text-center   ">
        ...
        <p1 className="text-xl text-center  text-gray-700 mt-12  ">
