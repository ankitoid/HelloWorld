...
import ServiceVid from "../../Assets/Videos/ServicesVid.mp4";
import { Helmet } from "react-helmet";
import { FiRefreshCw } from "react-icons/fi";
import { RiRouterLine } from "react-icons/ri";
import FiledServieImage from "../../Assets/ServicesPages/FieldEngServices.png";
const FieldServicesPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>GlobalXperts Field Services</title>
      ...
      <div className="bg-white max-w-7xl mx-auto flex items-center justify-center p-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 max-w-6xl">
          ...
          <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-8 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px]">
            <div className="flex flex-col items-center flex-grow">
              ...
              <p className="text-sm text-gray-600 mb-4 text-left">
                ...
                services offer fast, efficient solutions for network setup,
                hardware maintenance, and IT system deployments. Our engineers
                come directly to your location, minimizing downtime and ensuring
                smooth operations. Contact us today to see how our IT field
                engineering can keep your business running smoothly.
              </p>
            </div>
            <Link
              to="/service/Field-Engineering-Services"
          ...
          <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-8 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px]">
            ...
            <Link
              to="/service/Field-Services-Onsite"
              className="text-blue-700 text-sm font-medium hover:underline flex items-center justify-center mt-auto"
            >
              Read More <span className="ml-2">&rarr;</span>
            </Link>
      ...
      <div className="relative mt-4 bg-white 2xl:bg-gray-100 rounded-2xl shadow-lg p-8  flex items-center flex-col lg:flex-row justify-between max-w-7xl mx-auto">
        ...
        <div className="text-section max-w-lg">
          ...
          <a
            href="/path/to/brochure.pdf" // Replace with the actual path to your brochure file
            download
