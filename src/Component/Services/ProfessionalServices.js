...
const ProfessionalServices = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between ml-14 mr-14 mt-12">
        {/* Text Section */}
        <div className="flex-1 md:pr-8 mb-8 md:mb-0">
          ...
          <p className="text-lg text-gray-600 mb-8 text-center">
            ...
            services designed to enhance your operations, improve efficiency,
            and drive sustainable growth. With a focus on delivering excellence,
            we tailor our approach to meet your unique needs, ensuring your
      ...
      <div className="flex justify-center items-center bg-gray-100 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-7xl mx-auto">
          {cards.map((card, index) => (
            <div
              key={index}
              className="max-w-sm rounded overflow-hidden shadow-lg border border-greenCustomColor transition-transform transform hover:scale-105"
            >
      ...
      <div className="max-w-7xl flex flex-col lg:flex-row items-center mx-5 justify-between mt-32 pb-10">
        ...
        <div className="text-center lg:text-left lg:w-1/2 lg:pr-8">
          ...
          <p className="mt-3 text-lg text-gray-500 sm:mt-4">
            Simplify your data center management with our seamless migration
            solutions to the cloud. We offer flexibility, scalability, and
            security, partnering with industry leaders like Cisco and Arista to
            deliver cutting-edge technologies.
            <br />
            <br />
            Our expert team will guide you through every stage, reducing costs
            and boosting efficiency, allowing you to focus on what you do best.
      ...
      <div className="mt-20">
        <div className="max-w-7xl flex flex-col lg:flex-row items-center mx-5 justify-between pb-10">
          ...
          <div className="text-center lg:text-left lg:w-1/2 lg:pr-8">
            ...
            <p className="mt-3 text-xl text-gray-500 sm:mt-4">
              ...
              provide top-tier Enterprise Network Architects, Cloud Architects,
              and Application Developers, allowing you to focus on your goals
              while we handle the rest. Contact us today to learn more!
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-10">
          <p className="text-lg text-gray-600 border p-5 shadow-xl bg-grayCustomColor rounded-lg">
            ...
            quickly expand your IT team with skilled professionals. Enhance your
            IT environment, streamline operations, and accelerate growth with
            our flexible solutions.
          </p>
          <p className="text-lg text-gray-600 border p-5 shadow-xl bg-grayCustomColor rounded-lg">
            We integrate top-tier professionals with your team, offering
            flexible scaling without the costs and risks of traditional hiring.
            Our rigorous screening process ensures high-quality talent to meet
            your specific needs.
          </p>
          <p className="text-lg text-gray-600 border p-5 shadow-xl bg-grayCustomColor rounded-lg">
            Quickly scale your IT team and access skilled experts while we
            manage complex IT needs. Focus on core business functions and enjoy
            flexibility and control over your workforce.
          </p>
          <p className="text-lg text-gray-600 border p-5 shadow-xl bg-grayCustomColor rounded-lg">
            Our professional services provide a turnkey solution for
            organizations seeking to augment their IT staff with highly skilled
            professionals, allowing you to achieve your strategic objectives
        ...
        <div className="max-w-7xl flex flex-col lg:flex-row items-center mx-5 justify-between mt-32 pb-10">
          ...
          <div className="text-center lg:text-left lg:w-1/2 lg:pr-8">
            ...
            <p className="mt-3 text-xl text-gray-500 sm:mt-4">
              Welcome to GlobalXperts' network consulting services! Our
              experienced team offers tailored solutions for building and
              optimizing your network infrastructure. We analyze your current
              setup, design a customized network to enhance performance and
              security, and provide ongoing support to meet your evolving needs.
              Contact us to elevate your network and achieve your business
              goals!
            </p>
          </div>
        </div>
      ...
      <div className="mt-20 text-center mx-20">
        ...
        <p className="text-lg text-gray-600 mb-8">
          GlobalXperts offers comprehensive network consulting and design
          solutions for businesses aiming to build or optimize their
          infrastructure. Our value proposition includes:
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-10 mt-5">
        <p className="text-lg text-gray-600 mb-8 border p-5 shadow-xl bg-grayCustomColor rounded-lg">
          **Customized Solutions** – We tailor our network designs to meet your
          unique business needs, focusing on performance, cost reduction, and
          enhanced security.
        </p>
        <p className="text-lg text-gray-600 mb-8 border p-5 shadow-xl bg-grayCustomColor rounded-lg">
          **Expertise** – Our experienced consultants leverage industry best
          practices and advanced technologies to build reliable, scalable, and
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-10">
        <p className="text-lg text-gray-600 mb-8 border p-5 shadow-xl bg-grayCustomColor rounded-lg">
          **Ongoing Support** – We provide continuous assistance to maintain and
          optimize your network, adapting to your evolving business needs.
        </p>
        <p className="text-lg text-gray-600 mb-8 border p-5 shadow-xl bg-grayCustomColor rounded-lg">
          **Cost-Effective** – We develop cost-efficient network solutions that
          do not compromise performance or security.
        </p>
      </div>
