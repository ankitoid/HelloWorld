...
import StaffAugmentationImage from "../../Assets/ServicesPages/StaffAugmentationImage.png";
import ImplementationImage from "../../Assets/ServicesPages/ImplementationImage.png";
import CloudMigrationImage from "../../Assets/ServicesPages/CloudMigrationImage.png";
import PS1 from "../../Assets/ServicesPages/ps1.png";
...
const ProfessionalServices = () => {
  ...
  const faqs = [
    {
      question: "What does your Professional Services cover?",
      answer:
        "Our Professional Services offer comprehensive solutions, including data center migration, site surveys (data center and wireless), technical staff augmentation, and network consulting.",
    },
    {
      question: "How can Data Center Migration services benefit my business?",
      answer:
        "Our Data Center Migration services ensure a seamless transition with minimal downtime and risk, allowing you to focus on your operations while we handle the migration process efficiently.",
    },
    {
      question:
  ...
  return (
    <>
      ...
      <Helmet>
        <title>GlobalXperts Professional IT Services</title>
      ...
      <div className="md:bg-gray-100 lg:bg-white md:p-8 max-w-7xl mx-auto">
        <div className="text-center mb-8 text-2xl font-bold text-gray-800">
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-center  p-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 ">
            ...
            <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-8 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px] md:min-w-[350px]">
              ...
              <Link
                to="/service/Data-Center-Migration"
                className="text-blue-700 text-sm font-medium hover:underline flex items-center justify-center mt-auto"
              >
                Read More <span className="ml-2">&rarr;</span>
              </Link>
            ...
            <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-8 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px] md:min-w-[350px]">
              <div className="flex flex-col items-center flex-grow">
                ...
                <p className="text-sm text-gray-600 mb-4 text-left">
                  ...
                  need a team of experts who can get the job done. With our
                  staff augmentation program, you can access top-tier talent
                  without the hassle of recruiting, training, and managing new
                  employees. We seamlessly integrate our professionals with your
                  team, allowing you to scale your workforce up or down as
                  needed.
                </p>
              </div>
              <Link
                to="/service/Technical-Staff-Augmentation"
                className="text-blue-700 text-sm font-medium hover:underline flex items-center justify-center mt-auto"
              >
                Read More <span className="ml-2">&rarr;</span>
              </Link>
            ...
            <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-8 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px] md:min-w-[350px]">
              <div className="flex flex-col items-center flex-grow">
                ...
                <p className="text-sm text-gray-600 mb-4 text-left">
                  Our team can help you build a reliable, scalable, and secure
                  network infrastructure that will support your business goals.
                  Whether you are looking to build a new network infrastructure
                  or optimize your existing one, our team of experts will
                  provide you with the guidance and support you need to achieve
                  your goals.
                </p>
              </div>
              <Link
      ...
      <div className="md:bg-gray-100 lg:bg-white md:p-8">
        ...
        <div className="md:bg-gray-100 md:p-4 lg:bg-white grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-12 mb-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-6 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px]">
            <div className="flex flex-col items-center flex-grow">
              <img src={PS1} alt="Consulting and Advisory" className="mb-6" />
              <h3 className="text-lg font-semibold text-gray-800 mb-2 text-center">
            ...
            <Link
              to="/service/Consulting-Advisory"
              className="text-blue-700 text-sm font-medium hover:underline flex items-center justify-center mt-auto"
            >
