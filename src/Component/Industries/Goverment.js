...
import { FaAmericanSignLanguageInterpreting, FaCloud, FaDatabase, FaMagento, FaServicestack } from "react-icons/fa";
import edu from "../../Assets/goverment.jpg";
import Navbar from "../Navbar";
import Footer from "../Footer";
import gslogo from "../../Assets/gvlogo.png";
import ContactCard from "../Contact/ContactCard";
import { Link } from "react-router-dom";
import { FaComputerMouse, FaFileCode, FaManatSign } from "react-icons/fa6";
            ...
            <div className="h-auto  flex flex-col items-center lg:flex-row justify-betweenpx-6 lg:px-16">
              ...
              <div className="w-full text-center lg:text-left mt-10 lg:mt-20 order-3 lg:order-2">
                <p className="text-base lg:text-lg text-white max-w-xl mx-auto lg:mx-0 lg:mb-0 leading-relaxed">
                  “Transforming public services with reliable IT solutions for the digital age”
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 max-w-7xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gray-900 sm:text-3xl text-center mb-4" >
              ...
              <p className="text-lg leading-relaxed text-center text-gray-600 mb-4">
                Does your business need access to the latest technology
                solutions available? Consider our technology refresh program,
                  ...
                  <div className="bg-white 2xl:bg-gray-100 shadow-2xl  p-8 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px] ">
                    <div className="flex flex-col items-center flex-grow">
                      ...
                      <p className="text-sm text-gray-600 mb-4   text-left">
                        ...
                        for real-time collaboration,[JN1]  including document
                        sharing, video conferencing, and project management.
                        Leveraging industry-leading tools, we enable seamless
                        collaboration across teams and locations, ensuring
                  ...
                  <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-8 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px] ">
                    <div className="flex flex-col items-center flex-grow">
                      ...
                      <p className="text-sm text-gray-600 mb-4 text-left">
                        ...
                        offer a 4-hour response SLA in over 100 countries.
                      </p>
                    </div>
                  </div>
                </div>
