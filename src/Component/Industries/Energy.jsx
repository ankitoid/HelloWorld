          ...
          <div className="max-w-7xl mx-auto py-20 lg:h-[70vh] 2xl:h-[50vh]">
            <div className="h-auto  flex flex-col items-center lg:flex-row justify-betweenpx-6 lg:px-16">
              ...
              <div className="w-full text-center lg:text-left mt-10 lg:mt-20 order-3 lg:order-2">
                ...
                Innovative IT solutions for the energy sector.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="py-10 flex flex-col lg:flex-row items-center justify-between">
              ...
              <div className="mt-8 lg:mt-0 lg:w-1/2">
                <img
                  ...
                  src="https://main-website-images1.s3.ap-south-1.amazonaws.com/Industries/energy.jpg"
          ...
          <div className="bg-blueCustomColor p-8 mt-10">
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between">
              ...
              <div className="mt-8 lg:mt-0 lg:w-1/2">
                <img
                  className="w-full rounded-lg"
                  src="https://main-website-images1.s3.ap-south-1.amazonaws.com/Industries/securitySol.png"
