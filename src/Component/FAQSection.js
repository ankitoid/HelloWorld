    ...
    <div className="bg-white p-6 flex-1">
      ...
      <div className="space-y-4">
        {[
          ...
          {
            question:
              "Does the GlobalXperts team partner with Presidio, Adobe and others?",
            answer:
              "Yes, GlobalXperts partners with leading technology companies like Presidio, Adobe, and others to deliver cutting-edge digital solutions.",
          },
        ].map((item, index) => (
