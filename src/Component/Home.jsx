        ...
        <div className="w-full bg-blueCustomColor p-6 md:p-10 py-10 md:py-16 ">
          <div className="md:max-w-7xl md:mx-auto 2xl:w-full flex flex-col md:flex-row items-center md:justify-between ">
            <div className="text-center md:text-left mb-8 md:mb-0">
              <h1 className="text-white text-5xl md:text-5xl  font-semibold font-sans mb-4">
              ...
              <Link
                to="/Careers"
                className="bg-white text-black mt-10 font-bold hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 rounded-full px-4 py-2 transition duration-200 ease-in-out"
              >
                Explore Open Roles
              </Link>
            </div>
            <div className="flex flex-col md:flex-row justify-center text-center w-full items-center mt-10 md:mt-0">
              ...
              <div className="flex flex-col items-center mb-5 md:mb-0 md:ml-5">
                ...
                <div className="h-32 w-32 md:h-40 md:w-40 rounded-full overflow-hidden">
                  <img
                    src="https://main-website-images1.s3.ap-south-1.amazonaws.com/Lending-Page-Image/meetImage.png"
                    alt="Profile 4"
                    className="w-full h-full object-cover"
                  />
                </div>
