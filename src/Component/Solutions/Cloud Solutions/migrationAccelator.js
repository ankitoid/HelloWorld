  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Accelerate your migration journey with our Migration Accelerator Program. Get expert guidance and support to ensure a smooth and successful migration to the cloud."
        />
      </Helmet>
      ...
      <div className="flex flex-col md:flex-row items-center w-full ">
        ...
        <div className="flex-1 md:min-h-[400px] w-full flex items-center justify-center ">
          <iframe
            className="w-full md:w-[80%] h-[300px] md:h-[400px]" // Set a fixed height for video
      ...
      <div className="flex flex-col md:flex-row items-center w-full mt-4">
        ...
        <div className="flex-1 md:min-h-[400px] w-full flex items-center justify-center">
          <img
            className="w-full md:w-[80%] h-[300px] md:h-[400px] object-cover" // Set a fixed height for image
