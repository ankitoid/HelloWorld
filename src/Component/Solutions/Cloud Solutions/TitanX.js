...
const DataAssurance = () => {
  return (
    <>
      ...
      <Helmet>
        <title>Titan X - Data Transformation</title>
        <meta name="description" content="Titan X" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto py-20 lg:h-[70vh] 2xl:h-[50vh]">
          <div className="h-auto  flex flex-col items-center lg:flex-row justify-betweenpx-6 lg:px-16">
            <div className="w-full  text-center lg:text-left order-2 lg:order-1">
              ...
              <div className="sm:w-auto flex flex-col sm:flex-row justify-center lg:justify-start mt-6 lg:mt-10 space-y-4 sm:space-y-0 sm:space-x-4">
                <Link
                  to="/contact-us"
