...
import VMwareCloudImg from "../../../Assets/VMwareCloud.png";
import VMwareAWS from "../../../Assets/VMwareAWS.png";
  ...
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            ...
            <div className="w-full text-center lg:text-left mt-10 lg:mt-20 order-3 lg:order-2">
              <p className="text-base lg:text-lg text-white max-w-xl mx-auto lg:mx-0 lg:mb-0 leading-relaxed">
                “VMware tools and the vast potential of AWS cloud services.
                However, successfully managing this hybrid environment comes
        ...
        <div className="bg-white p-6 rounded-lg shadow-md max-w-7xl mx-auto">
          <ul className="list-disc pl-6 space-y-4 text-gray-700">
            <li>
              ...
              virtualization, VMware Cloud on AWS lets you leverage those
              existing skills and tools in the cloud environment. This reduces
              complexity and training needs during migration.
            </li>
            <li>
              <span className="font-semibold">
                Consistent infrastructure and operations:
              </span>{" "}
              VMware Cloud on AWS provides a consistent environment that bridges
              your on-premises data center and the AWS cloud. This simplifies
              management and minimizes the challenges of working with two
              completely different environments.
            </li>
            <li>
              <span className="font-semibold">Simplified cloud migration:</span>{" "}
              VMware Cloud on AWS is designed for seamless migration of existing
              VMware workloads to the cloud. You can potentially migrate your
              virtual machines (VMs) without needing to convert or re-architect
              them, reducing downtime and costs.
            </li>
            <li>
              <span className="font-semibold">Leverage AWS innovation:</span>{" "}
              While maintaining a familiar VMware environment, VMware Cloud on
              AWS also allows you to tap into the vast range of AWS services and
            ...
            <li>
              ...
              VMware Cloud on AWS offers a combined support model from both
              VMware and AWS. This ensures you get expert assistance whenever
              needed.
            </li>
          </ul>
          ...
          <p className="mt-4 text-gray-700">
            Overall, VMware Cloud on AWS is a good choice if you’re looking for
            a smooth and familiar path to migrate your VMware workloads to the
            cloud while also being able to leverage the benefits and innovation
            of AWS.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto p-8 bg-gray-50">
        ...
        <img className="w-full h-auto" src={VMwareCloudImg} />
      </div>
