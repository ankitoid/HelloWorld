...
import HybridCloudImage from "../../../Assets/SMBsLogo/HybridCloud.webp";
import { Link } from "react-router-dom";
import { FaDatabase } from "react-icons/fa";
import HybridCloudArch from "../../../Assets/SMBsLogo/HbridCloudArch.png"
    ...
    <>
      ...
      <div className="flex flex-col md:flex-row items-center bg-white 2xl:bg-white   rounded-lg shadow-md p-6 py-4 max-w-7xl mx-auto mt-12">
        ...
        <div className="w-full md:w-1/2">
          <img
            src={HybridCloudImage} // Replace with the actual image path
            alt="Boost outcomes"
      ...
      <div className="max-w-7xl mx-auto mt-12">
        ...
        <section className="py-6 px-4 sm:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Extremely Low Latency", icon: <FaDatabase />              },
              { title: "Strict Security Measures", image: "security.png" },
              { title: "Data Residency", image: "data.png" },
              { title: "Compliance Requirements", image: "compliance.png" },
            ].map((item, index) => (
              <div
                key={index}
        ...
        <h3 className="text-2xl font-bold mt-8 mb-4 text-center">How Does AWS Outposts Work?</h3>
        <p className="text-lg text-gray-700 mb-4 text-center">Outposts essentially migrates AWS to your premises instead of the other way around. The services you use are still fully managed by AWS.</p>
        <div className="flex flex-wrap justify-center mb-8">
            <ul className="list-disc  text-lg text-gray-700">
              <li className=" items-center list-item mb-2">Amazon hardware is installed on your premises.</li>
              <li className=" items-center list-item mb-2">A private edge location is created in AWS for your “outpost.”</li>
              <li className=" items-center list-item mb-2">You run your sensitive system components in this edge location using Amazon EKS containers.</li>
              <li className=" items-center list-item mb-2">These components are managed like any other workload in AWS.</li>
            </ul>
           <div className=" mt-20">
           <img src={HybridCloudArch} alt="hybrid cloud" className="w-5/4" />
           </div>
        </div>
        <h3 className="text-2xl font-bold mb-4 text-center">Let Us Build a Solution For You</h3>
        <p className="text-lg text-gray-700 text-center">GlobalXperts can design a solution that works best for your systems and can then migrate your workloads to it, giving you access to the benefits of the cloud on your premises. Contact us today.</p>
      </div>
