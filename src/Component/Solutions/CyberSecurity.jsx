    ...
    <Helmet>
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-300 mb-8">
          Our team is made up of cybersecurity experts with years of experience in the field. We stay up-to-date with the
          latest threats and trends in the industry, so you can be confident that you’re receiving the most effective and relevant
          security solutions.
        </p>
      </div>

      <div className="max-w-4xl mx-auto bg-gray-800 p-6 rounded-xl shadow-lg">
        <h3 className="text-2xl font-semibold mb-4 text-center">Industry Certifications</h3>
      ...
      <div className="max-w-4xl mx-auto bg-gray-800 p-6 mt-6 rounded-xl shadow-lg">
        <h3 className="text-2xl font-semibold mb-4 text-center">Customized Security Solutions</h3>
        <p className="text-gray-300">
          We understand that every business is different—that is why we’ll work with you to develop customized security
          solutions that meet your specific needs. Our services will be tailored to meet your unique requirements.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto text-center mt-10">
        ...
        <p className="text-gray-300 mb-6">
          Every organization needs protection against cybersecurity threats. GlobalXperts is here to help. If you think your
          systems are vulnerable, don’t wait for Day Zero. Contact us today.
        </p>
        <a
          href="#contact"
