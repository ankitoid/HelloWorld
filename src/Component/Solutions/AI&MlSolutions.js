...
import AiSolutions from "../../Assets/SMBsLogo/aiSolutions.jpg";
  ...
  const boxContent = [
    {
      ...
      description:
        "AI/ML solutions to improve patient care, streamline EHRs, and enhance analytics.",
      image:
        "https://d1d9irqvk1xh20.cloudfront.net/wp-content/uploads/2024/11/health-1024x683.png", // Replace with your image path
    },
    {
      title: "Industrial and manufacturing",
      description:
        "Tools for predictive maintenance, quality control, and process automation.",
      image:
        "https://d1d9irqvk1xh20.cloudfront.net/wp-content/uploads/2024/11/finance-1024x683.png", // Replace with your image path
    },
    {
      title: "Financial services",
      description:
        "Fraud detection, risk analysis, and smarter customer engagement.",
      image:
        "https://d1d9irqvk1xh20.cloudfront.net/wp-content/uploads/2024/11/industry-1024x683.png", // Replace with your image path
    },
    {
      title: "Retail",
      description:
        "Personalized shopping experiences and operational efficiency with AI.",
      image:
        "https://d1d9irqvk1xh20.cloudfront.net/wp-content/uploads/2024/11/retail-1024x683.png", // Replace with your image path
    },
    {
      title: "Media and entertainment",
      description:
        "Creative tools for content generation, media enhancement, and audience engagement.",
      image:
        "https://d1d9irqvk1xh20.cloudfront.net/wp-content/uploads/2024/11/mediaEntertement-1024x683.png", // Replace with your image path
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI Solutions" />
      </Helmet>
      {/* Navbar Section */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="relative bg-[#161E2D] p-6 rounded-lg text-center flex flex-col justify-between">
              ...
              <p className="bg-gradient-to-r from-pink-200 via-pink-50 to-blue-200 bg-clip-text text-transparent mt-8">
                Extract insights from corporate information for faster
                decisions.
              </p>
            </div>
            ...
            <div className="relative bg-[#161E2D] p-6 rounded-lg text-center flex flex-col justify-between">
              ...
              <p className="bg-gradient-to-r from-pink-200 via-pink-50 to-blue-200 bg-clip-text text-transparent">
                Create new content and ideas, including conversations and
                stories.
              </p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-[#1f2937] border border-cyan-500 rounded-lg p-6 flex flex-col items-center text-center">
            ...
            <p className="text-white">
              Generative AI capabilities enable new use cases (e.g., Content
              creation)
            </p>
          </div>
          ...
          <div className="bg-[#1f2937] border border-orange-500 rounded-lg p-6 flex flex-col items-center text-center">
            ...
            <p className="text-white">
              Combines traditional ML and deep learning with generative AI for
              improved use cases.
            </p>
          </div>
          ...
          <div className="bg-[#1f2937] border border-pink-500 rounded-lg p-6 flex flex-col items-center text-center">
            ...
            <p className="text-white">
              Traditional AI use cases that remain high value (e.g., Predictive
              analytics)
            </p>
          </div>
        </div>
      ...
      <div className="container mx-auto p-8 bg-blue-300 rounded-lg shadow-xl">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-bold text-gray-800">Industries That Benefit From AI</h2>
        <p className="text-lg text-gray-600">
          With GlobalXperts’s suite of AI/ML services, the following industries can leverage our solutions:
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
        ...
        <div className="bg-gradient-to-r from-green-400 to-blue-500 shadow-lg rounded-lg p-6 text-center">
          <h3 className="text-xl font-semibold text-white">Healthcare and Life Sciences</h3>
        </div>
        ...
        <div className="bg-gradient-to-r from-yellow-500 to-red-500 shadow-lg rounded-lg p-6 text-center">
          <h3 className="text-xl font-semibold text-white">Industrial and Manufacturing</h3>
        </div>
        ...
        <div className="bg-gradient-to-r from-orange-400 to-pink-400 shadow-lg rounded-lg p-6 text-center">
          <h3 className="text-xl font-semibold text-white">Media and Entertainment</h3>
        </div>
      </div>

      <p className="text-gray-800 text-center mt-8 max-w-3xl mx-auto text-lg">
        AI and machine learning solutions can greatly benefit your business. Contact us today to learn more about the AI solutions we can build for you.
      </p>
    </div>
