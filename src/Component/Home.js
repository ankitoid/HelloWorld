...
import Icn13 from "../Assets/Technologies/nodeIcon.png";
import Icn14 from "../Assets/Technologies/reactIcon.png";
import Icn15 from "../Assets/Technologies/expressjsIcon.jpg";
import Icn16 from "../Assets/Technologies/terraform.png";
        ...
        <div className="relative overflow-hidden w-full h-16 bg-white mt-14    ">
          <div className="absolute flex whitespace-nowrap animate-slide">
            <div className="flex items-center space-x-4 gap-10 mt-2">
              ...
              <img src={Icn13} alt="Logo" className="h-12" />
              <img src={Icn14} alt="Logo" className="h-12" />
              <img src={Icn15} alt="Logo" className="h-12" />
              <img src={Icn16} alt="Logo" className="h-12" />
        ...
        <div className="w-full bg-greenCustomColor2 p-6 md:p-10 py-10 md:py-16 ">
          <div className="flex flex-col md:flex-row items-center md:justify-between ">
            <div className="text-center md:text-left mb-8 md:mb-0">
              ...
              <Link to="/Careers" className="bg-white text-black mt-10 font-bold hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 rounded-full px-4 py-2 transition duration-200 ease-in-out">
                Explore open roles
              </Link>
            </div>
