...
// import ConsultingAndAdvisory from "./Component/Services/Professional Service/";
// import ConsultingAndAdvisory from "./Component/Services/Professional Service/";
      ...
      <div className="flex-grow">
        <Routes>
          ...
          <Route
            ...
            element={<VMwareCloud />}
          />
          <Route path="/solutions/cloud/Blockchain-Technology" element={<Blockchain />} />
          ...
          {/* Field Service Page */}
          <Route path="/service/Field-Services-Onsite" element={<FieldServiceOnsite />}/>
          <Route path="/service/Field-Engineering-Services" element={<FieldServiceEng />}/>
          <Route path="/service/Technology-Refresh" element={<TechnologyRefresh />} />
          
          <Route path="/LoginSignup" element={<LoginSignup />} />

        {/* Managed Services Pages */}
        <Route path="/service/Managed-Collaboration-Technologies"  element={<ManagedCollaborationTech/>}/>
        <Route path="/service/Managed-Cyber-Security" element={<ManagedCyberSecurity />} />
        <Route path="/service/Managed-Networking" element={<ManagedNetworking />} />
        <Route path="/service/Managed-Opsis-Streaming" element={<ManagedOpsisStream />} />
        <Route path="/service/Managed-Help-Desk" element={<ManagedHelpDesk />} />
        <Route path="/service/Managed-Cloud" element={<ManagedCloud />} />

{/* professional services */}
        <Route path="/service/Staff-Augmentation" element={<StaffAugmentation />} />
        <Route path="/service/Consulting-Advisory" element={<ConsultingAndAdvisory />} />
        ...
        <Route path="/service/Data-Center-Migration" element={<DataCenterMigration />} />
        <Route path="/service/Technical-Staff-Augmentation" element={<TechStaffAug />} />
        {/* Solutions -> Cloud Solutions */}
        <Route path="/solution/Cloud-Solutions/OmniBot" element={<OmniBot />} />
        <Route path="/solutions/Cloud/Hybrid-Cloud" element={<HybridCloud/>}/>
